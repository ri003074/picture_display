...
def image_display():
    ...
    if directory_path_1 or directory_path_2 or directory_path_3 or directory_path_4:  # At least one directory should be specified
        ...
        if png_files_1 or png_files_2 or png_files_3 or png_files_4:
            ...
            elif valid_dir_1 and valid_dir_2 and valid_dir_3 and not valid_dir_4:
                num_columns = 3
            ...
            elif valid_dir_1 and valid_dir_2 and valid_dir_3 and valid_dir_4:
                num_columns = 4
        ...
        if not valid_dir_1 and not valid_dir_2 and not valid_dir_3 and not valid_dir_4:
